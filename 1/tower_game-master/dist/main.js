...
function(e, t, i) {
    ...
    t.blockAction = function(e, t, i) {
        ...
        if (o.visible) {
            ...
            switch (o.status) {
            case a.swing:
                t.getTimeMovement(a.hookDownMovement, [[e.y, e.y + s]],
                function(t) {
                    e.y = t
                },
                {
            ...
            case a.drop:
                ...
                case 5:
                    o.status = a.land;
                    var g = t.getVariable(a.successCount); (0, n.addSuccessCount)(t),
                    ...
                    var f = .3 * o.width; (o.x > t.width - 2 * f || o.x < -f) && t.setVariable(a.hardMode, !0),
                    5 === l ? (e.perfect = !0, (0, n.addScore)(t, !0), t.playAudio("drop-perfect")) : ((0, n.addScore)(t), t.playAudio("drop"))
                }
                break;
            case a.land:
...
function(e, t, i) {
    ...
    t.endAnimate = function(e) {
        if (e.getVariable(s.gameStartNow)) {
            ...
            a = Number(t) > 99 ? .1 * e.width: 0; (0, r.drawYellowString)(e, {
                string: "层",
                size: .06 * e.width,
                x: .24 * e.width + a,
                y: .12 * e.width,
            ...
            for (var h = e.ctx,
            g = e.getImg("heart"), f = g.width, v = g.height, m = .08 * e.width, p = v * m / f, y = 1; y <= 3; y += 1) h.save(),
            y <= i && (h.globalAlpha = .2),
...
function(e, t, i) {
    ...
    t.hookAction = function(e, t, i) {
        ...
        t.getTimeMovement(a.hookUpMovement, [[e.y, e.y - r]],
        function(t) {
            e.y = t
        },
        {
        ...
        t.getTimeMovement(a.hookDownMovement, [[e.y, e.y + r]],
        function(t) {
            e.y = t
        },
        {
...
function(e, t, i) {
    ...
    t.cloudAction = function(e, t) {
        ...
        e.y >= t.height && (e.y = .66 * -t.height, e.count += 4, r(e))
    };
...
function(e, t, i) {
    ...
    t.lineAction = function(e, t, i) {
        var r = e;
        r.ready || (r.y = t.getVariable(a.lineInitialOffset), r.ready = !0, r.collisionX = t.width - t.getVariable(a.blockWidth)),
        t.getTimeMovement(a.moveDownMovement, [[e.y, e.y + (0, n.getMoveDownValue)(t, {
            pixelsPerFrame: function(e) {
                return e / 2
            }
...
function(e, t, i) {
    ...
    var r = function(e) {
        ...
        {
            name: "background"
        }), e.getTimeMovement(a.bgInitMovement, [[o, o + r / 4]],
        function(e) {
            o = e
    ...
    s = function(e) {
        ...
        r = e.getVariable(a.bgLinearGradientOffset, 0); (0, n.checkMoveDown)(e) && e.setVariable(a.bgLinearGradientOffset, r + 1.5 * (0, n.getMoveDownValue)(e));
        ...
        e.getTimeMovement(a.lightningMovement, [],
        function() {},
        {
            before: d,
            after: d
...
function(e, t, i) {
    ...
    var a, r = (a = 1e3 / 60, window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
    function(e) {
    ...
    d = function() {
        function e() {
            ...
            if (function(e, t) {
                ...
                s && (this.canvas.style.width = "".concat(d, "px"), this.canvas.style.height = "".concat(h, "px"), d *= 2, h *= 2),
                ...
                !1),
                this.isTouchDevice ? (document.addEventListener("touchstart",
                function(e) {
                ...
                !1), document.addEventListener("mousemove",
                function(e) {
                    g.touchMoveListener(e)
                },
                !1))
...
function(e, t, i) {
    ...
    window.TowerGame = function() {
        ...
        f.addKeyDownListener("enter",
        function() {
            f.debug && f.togglePaused()
        }),
        f.touchStartListener = function() { (0, a.touchEventHandler)(f)
        },
        f.playBgm = function() {
            f.playAudio("bgm", !0)
        },
